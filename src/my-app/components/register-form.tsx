  ...
  return (
    <form onSubmit={onSubmit} className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div className="grid gap-6">
        ...
        <Button variant="outline" type="button" className="w-full" onClick={() => alert('Implement GitHub OAuth')}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="mr-2 size-4" aria-hidden="true" focusable="false">
